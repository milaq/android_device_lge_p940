...
typedef struct hwc_layer {
    ...
    union {
      ...
      uint32_t buf_layout;
      /* These are needed to make the size of the layer data structure 
         line up. I suspect they're extensions for Real3D */
      uint32_t moarPadding1;
      uint32_t moarPadding2;
      uint32_t moarPadding3;
      uint32_t moarPadding4;
        };
    };
} hwc_layer_t;
