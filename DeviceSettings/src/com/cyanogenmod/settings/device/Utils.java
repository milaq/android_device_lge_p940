...
public class Utils {
    private static final String TAG = "P940Parts_Utils";
    private static final String TAG_READ = "P940Parts_Utils_Read";
    private static final String TAG_WRITE = "P940Parts_Utils_Write";
